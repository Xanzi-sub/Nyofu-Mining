      ...
      {step === "select" && (
        <>
          ...
          <div className="mt-5 overflow-hidden border border-[#D8DDE2] bg-white">
            <div className="grid grid-cols-[1.6fr_1fr_1fr_120px] border-b border-[#D8DDE2] bg-[#F7F8F9] px-5 py-3 text-[10px] font-semibold uppercase tracking-[0.08em] text-[#7A858F]">
              <span>Package</span>
              <span>Capital</span>
            ...
            {packages.map((pkg) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "grid w-full grid-cols-[1.6fr_1fr_1fr_120px] items-center border-b border-[#E5E8EB] px-5 py-5 text-left last:border-b-0",
                    active
                      ? "bg-[#FCFAF4]"
                ...
                >
                  ...
                  <p className="text-[13px] font-medium tabular-nums text-[#27323C]">
                    {formatCurrency(pkg.min_amount)}
                  </p>

                  <p className="text-[13px] font-medium tabular-nums text-[#8C702B]">
          ...
          <div className="mt-5 flex items-center justify-between">
            ...
            <button
              ...
              className="h-9 shrink-0 bg-[#B9973E] px-5 text-[12px] font-semibold text-white hover:bg-[#A98735] disabled:cursor-not-allowed disabled:opacity-50"
            >
              Continue
            </button>
          </div>
      ...
      {step === "review" && selected && (
        <div className="max-w-[820px]">
          ...
          <div className="mt-5 border border-[#D8DDE2] bg-white">
            ...
            <dl>
              <div className="grid grid-cols-[220px_1fr] border-b border-[#E5E8EB] px-6 py-4">
              ...
              <div className="grid grid-cols-[220px_1fr] px-6 py-4">
                <dt className="text-[12px] text-[#7A858F]">
            ...
            <div className="border-t border-[#D8DDE2] px-6 py-5">
          ...
          <div className="mt-5 flex gap-3">
            <button
              ...
              className="h-9 border border-[#CBD2D8] bg-white px-5 text-[12px] font-medium text-[#4D5964] hover:bg-[#F7F8F9]"
            >
              Back
            </button>
            ...
            <button
              ...
              className="flex h-9 items-center justify-center gap-2 bg-[#B9973E] px-5 text-[12px] font-semibold text-white hover:bg-[#A98735] disabled:cursor-not-allowed disabled:opacity-60"
            >
